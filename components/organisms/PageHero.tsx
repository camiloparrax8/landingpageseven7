...
export function PageHero({
  ...
  return (
    <section
      className={cn(
        "relative overflow-hidden border-b border-ink/[0.08] bg-cover bg-center bg-no-repeat py-[88px] pb-[72px] max-md:py-[60px] max-md:pb-12 max-[480px]:py-12 max-[480px]:pb-9",
