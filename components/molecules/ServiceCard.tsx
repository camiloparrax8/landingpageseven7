...
export function ServiceCard({ card }: ServiceCardProps) {
  ...
  return (
    <article className="flex min-h-[280px] flex-col rounded-[18px] border border-ink/[0.08] bg-white p-7 shadow-[0_10px_28px_rgba(29,53,80,0.05)] max-[480px]:px-[18px] max-[480px]:py-[22px]">
      <div
        className={
      ...
      <Link href={href} className="mt-auto pt-5 text-sm font-bold text-ink">
        {linkLabel}
      </Link>
    </article>
  );
